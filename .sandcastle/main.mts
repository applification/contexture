...
// blows past sandcastle's hard-coded 60s copy timeout. The onSandboxReady
// `bun install` hook below runs inside the container instead — slower on
// first sandbox boot, but reliable.
