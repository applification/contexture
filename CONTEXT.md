...
- **Legacy bare IR**: A standalone `.contexture.json` without `.contexture/` sidecars. Contexture can read these directly; the first explicit save, emit, or mutation materializes bundle sidecars and generated targets.
