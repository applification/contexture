/**
 * `@contexture/runtime/contact` — re-export of the `contact` stdlib namespace.
 *
 * This is the module that generated `.schema.ts` files import from:
 * the editor's Zod emitter rewrites `import { Email } from '@contexture/contact'`
 * into `import { Email } from '@contexture/runtime/contact'`. Keeping the
 ...
 */
export * from '@contexture/stdlib/contact';
